...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bundles/compression.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./bundles/compression.js":
/*!********************************!*\
  !*** ./bundles/compression.js ***!
  \********************************/
/*! no exports provided */
...
/* harmony import */ var _modules_compression_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/compression.js */ "./modules/compression.js");
/* harmony import */ var _modules_compression_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_compression_js__WEBPACK_IMPORTED_MODULE_0__);


/***/ }),

/***/ "./modules/compression.js":
/*!********************************!*\
  !*** ./modules/compression.js ***!
  \********************************/
...
window.sf.compression = function (exports) {
  'use strict';
  /**
   * array literal codes
   */
  ...
  var CompressedStreamWriter = function () {
    ...
    CompressedStreamWriter.prototype.write = function (data, offset, length) {
      ...
      if (typeof data === 'string') {
        var encode = new sf.fileutils.Encoding(false);
        encode.type = 'Utf8';
  ...
  var ZipArchive = function () {
    ...
    function ZipArchive() {
      ...
      this.files = [];
      this.level = 'Normal';
      sf.fileutils.Save.isMicrosoftBrowser = !!navigator.msSaveBlob;
    }
    ...
    ZipArchive.prototype.writeZippedContent = function (fileName, zipData, localDirLen, skipFileSave) {
      ...
      if (!skipFileSave) {
        sf.fileutils.Save.save(fileName, blob);
      }
  ...
  exports.CompressedStreamWriter = CompressedStreamWriter;
  exports.CompressorHuffmanTree = CompressorHuffmanTree;
