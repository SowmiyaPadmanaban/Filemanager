...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bundles/datepicker.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _modules_datepicker_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/datepicker.js */ "./modules/datepicker.js");
/* harmony import */ var _modules_datepicker_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_datepicker_js__WEBPACK_IMPORTED_MODULE_0__);
...
var sfdatepicker = function sfdatepicker(exports) {
  'use strict';
  ...
  var DatePicker = function (_super) {
    ...
    DatePicker.prototype.restoreValue = function () {
      ...
      this.previousElementValue = sf.base.isNullOrUndefined(this.inputValueCopy) ? '' : this.globalize.formatDate(this.inputValueCopy, {
        format: this.formatString,
        type: 'dateTime',
        skeleton: sf.base.isBlazor() ? 'd' : 'yMd'
      });
    ...
    DatePicker.prototype.documentHandler = function (e) {
      if (!sf.base.isNullOrUndefined(this.popupObj) && (this.inputWrapper.container.contains(e.target) || this.popupObj.element && this.popupObj.element.contains(e.target)) && e.type !== 'touchstart') {
        e.preventDefault();
      }

      var target = e.target;

      if (!sf.base.closest(target, '.e-datepicker.e-popup-wrapper') && !(sf.base.closest(target, '.' + INPUTCONTAINER) === this.inputWrapper.container) && !target.classList.contains('e-day')) {
        this.hide(e);
        this.focusOut();
        ...
        if (target.classList.contains('e-day') && !sf.base.isNullOrUndefined(e.target.parentElement) && e.target.parentElement.classList.contains('e-selected') && sf.base.closest(target, '.e-content') && sf.base.closest(target, '.e-content').classList.contains('e-' + this.depth.toLowerCase())) {
          this.hide(e);
        } else if (sf.base.closest(target, '.e-footer-container') && target.classList.contains('e-today') && target.classList.contains('e-btn') && +new Date(+this.value) === +_super.prototype.generateTodayVal.call(this, this.value) && !this.isBlazorServer) {
          this.hide(e);
        }
      }
    };
    ...
    DatePicker.prototype.popupUpdate = function () {
      if (sf.base.isNullOrUndefined(this.value) && !sf.base.isNullOrUndefined(this.previousDate) || +this.value !== +this.previousDate) {
        if (this.popupObj) {
    ...
    DatePicker.prototype.strictModeUpdate = function () {
      ...
      if (this.getModuleName() === 'datetimepicker') {
        ...
        date = this.globalize.parseDate(this.inputElement.value, dateOptions);
        date = !sf.base.isNullOrUndefined(date) && isNaN(+date) ? null : date;
    ...
    DatePicker.prototype.destroy = function () {
      ...
      if (this.inputElement) {
        ...
        if (!sf.base.isNullOrUndefined(this.inputElementCopy.getAttribute('tabindex'))) {
          this.inputElement.setAttribute('tabindex', this.tabIndex);
        } else {
    ...
    DatePicker.prototype.checkHtmlAttributes = function (dynamic) {
      ...
      this.checkFormat();
      this.checkView();
      var attributes$$1 = dynamic ? sf.base.isNullOrUndefined(this.htmlAttributes) ? [] : Object.keys(this.htmlAttributes) : ['value', 'min', 'max', 'disabled', 'readonly', 'style', 'name', 'placeholder', 'type'];
      var options;
    ...
    DatePicker.prototype.errorClass = function () {
      ...
      if (!sf.base.isNullOrUndefined(this.value) && !(+new Date(+this.value).setMilliseconds(0) >= +this.min && +new Date(+this.value).setMilliseconds(0) <= +this.max) || !this.strictMode && this.inputElement.value !== '' && sf.base.isNullOrUndefined(this.value) || isDisabledDate) {
    ...
    __decorate([sf.base.Property(null)], DatePicker.prototype, "width", void 0);

    __decorate([sf.base.Property(null)], DatePicker.prototype, "value", void 0);

    __decorate([sf.base.Property(null)], DatePicker.prototype, "cssClass", void 0);

    __decorate([sf.base.Property(false)], DatePicker.prototype, "strictMode", void 0);

    __decorate([sf.base.Property(null)], DatePicker.prototype, "format", void 0);

    __decorate([sf.base.Property(true)], DatePicker.prototype, "enabled", void 0);

    __decorate([sf.base.Property({})], DatePicker.prototype, "htmlAttributes", void 0);

    __decorate([sf.base.Property(null)], DatePicker.prototype, "values", void 0);

    __decorate([sf.base.Property(false)], DatePicker.prototype, "isMultiSelection", void 0);

    __decorate([sf.base.Property(true)], DatePicker.prototype, "showClearButton", void 0);

    __decorate([sf.base.Property(true)], DatePicker.prototype, "allowEdit", void 0);

    __decorate([sf.base.Property(null)], DatePicker.prototype, "keyConfigs", void 0);

    __decorate([sf.base.Property(false)], DatePicker.prototype, "enablePersistence", void 0);

    __decorate([sf.base.Property(1000)], DatePicker.prototype, "zIndex", void 0);

    __decorate([sf.base.Property(false)], DatePicker.prototype, "readonly", void 0);

    __decorate([sf.base.Property(null)], DatePicker.prototype, "placeholder", void 0);

    __decorate([sf.base.Property('Never')], DatePicker.prototype, "floatLabelType", void 0);

    __decorate([sf.base.Property(null)], DatePicker.prototype, "serverTimezoneOffset", void 0);

    __decorate([sf.base.Property(false)], DatePicker.prototype, "openOnFocus", void 0);

    __decorate([sf.base.Event()], DatePicker.prototype, "open", void 0);

    __decorate([sf.base.Event()], DatePicker.prototype, "cleared", void 0);

    __decorate([sf.base.Event()], DatePicker.prototype, "close", void 0);

    __decorate([sf.base.Event()], DatePicker.prototype, "blur", void 0);

    __decorate([sf.base.Event()], DatePicker.prototype, "focus", void 0);

    __decorate([sf.base.Event()], DatePicker.prototype, "created", void 0);

    __decorate([sf.base.Event()], DatePicker.prototype, "destroyed", void 0);

    DatePicker = __decorate([sf.base.NotifyPropertyChanges], DatePicker);
    return DatePicker;
