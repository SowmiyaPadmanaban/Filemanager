...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bundles/daterangepicker.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./bundles/daterangepicker.js":
/*!************************************!*\
  !*** ./bundles/daterangepicker.js ***!
  \************************************/
/*! no exports provided */
...
/* harmony import */ var _modules_daterangepicker_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/daterangepicker.js */ "./modules/daterangepicker.js");
/* harmony import */ var _modules_daterangepicker_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_daterangepicker_js__WEBPACK_IMPORTED_MODULE_0__);


/***/ }),

/***/ "./modules/daterangepicker.js":
/*!************************************!*\
  !*** ./modules/daterangepicker.js ***!
  \************************************/
...
var sfdaterangepicker = function sfdaterangepicker(exports) {
  'use strict';
  ...
  var Presets = function (_super) {
    ...
    __decorate([sf.base.Property()], Presets.prototype, "label", void 0);

    __decorate([sf.base.Property()], Presets.prototype, "start", void 0);

    __decorate([sf.base.Property()], Presets.prototype, "end", void 0);
  ...
  var DateRangePicker = function (_super) {
    ...
    DateRangePicker.prototype.initialize = function () {
      ...
      sf.base.merge(this.defaultKeyConfigs, {
        shiftTab: 'shift+tab'
      });
        ...
        for (var _i = 0, _a = Object.keys(this.htmlAttributes); _i < _a.length; _i++) {
          ...
          if (wrapperAttr.indexOf(key) > -1) {
            if (key === 'class') {
              ...
              dateRangeStyle = !sf.base.isNullOrUndefined(dateRangeStyle) ? dateRangeStyle + this.htmlAttributes[key] : this.htmlAttributes[key];
    ...
    DateRangePicker.prototype.checkHtmlAttributes = function (isDynamic) {
      this.globalize = new sf.base.Internationalization(this.locale);
      var attributes$$1 = isDynamic ? sf.base.isNullOrUndefined(this.htmlAttributes) ? [] : Object.keys(this.htmlAttributes) : ['startDate', 'endDate', 'minDays', 'maxDays', 'min', 'max', 'disabled', 'readonly', 'style', 'name', 'placeholder', 'type', 'value'];
      var format = {
    ...
    DateRangePicker.prototype.createPopup = function () {
      ...
      this.popupWrapper = sf.base.createElement('div', {
    ...
    DateRangePicker.prototype.calendarIconRipple = function () {
      sf.base.rippleEffect(this.leftCalPrevIcon, {
        selector: '.e-prev',
        duration: 400,
        isCenterRipple: true
      });
      sf.base.rippleEffect(this.leftCalNextIcon, {
        selector: '.e-next',
        duration: 400,
        isCenterRipple: true
      });
      sf.base.rippleEffect(this.rightCalPrevIcon, {
        selector: '.e-prev',
        duration: 400,
        isCenterRipple: true
      });
      sf.base.rippleEffect(this.rightCalNextIcon, {
        selector: '.e-next',
        duration: 400,
        isCenterRipple: true
      });
    ...
    DateRangePicker.prototype.errorClass = function () {
      ...
      if ((sf.base.isNullOrUndefined(this.endValue) && sf.base.isNullOrUndefined(this.startValue) && inputStr !== '' || !sf.base.isNullOrUndefined(this.startValue) && +this.startValue < +this.min || !sf.base.isNullOrUndefined(this.startValue) && !sf.base.isNullOrUndefined(this.endValue) && +this.startValue > +this.endValue || !sf.base.isNullOrUndefined(this.endValue) && +this.endValue > +this.max || this.startValue && this.isDateDisabled(this.startValue) || this.endValue && this.isDateDisabled(this.endValue)) && inputStr !== '') {
    ...
    DateRangePicker.prototype.hoverSelection = function (event, element) {
      ...
      if (!sf.base.isNullOrUndefined(this.startValue) && +this.startValue >= +this.min && +this.startValue <= +this.max) {
        if (!this.isDateDisabled(this.endValue) && !this.isDateDisabled(this.startValue) && sf.base.isNullOrUndefined(this.endValue) && sf.base.isNullOrUndefined(this.startValue) || !sf.base.isNullOrUndefined(this.startValue) && sf.base.isNullOrUndefined(this.endValue)) {
        ...
        for (var _i = 0, elementCollection_1 = elementCollection; _i < elementCollection_1.length; _i++) {
          ...
          for (var _a = 0, tdCells_3 = tdCells; _a < tdCells_3.length; _a++) {
            ...
            if (!ele.classList.contains(WEEKNUMBER) && !ele.classList.contains(DISABLED)) {
              ...
              if (ele.classList.contains(SELECTED) && ele.classList.contains(ENDDATE) && +eleDateValue !== +this.endValue) {
              ...
              if (!ele.classList.contains(OTHERMONTH)) {
                ...
                if (this.currentView() === this.depth && !sf.base.isNullOrUndefined(this.endValue) && +eleDateValue_1.setHours(0, 0, 0, 0) === +endDateValue.setHours(0, 0, 0, 0) && +eleDateValue_1.setHours(0, 0, 0, 0) <= +endDateValue.setHours(0, 0, 0, 0) && +this.startValue >= +this.min && !this.inputWrapper.container.classList.contains('e-error') && !(this.isDateDisabled(this.startValue) || this.isDateDisabled(this.endValue))) {
    ...
    DateRangePicker.prototype.rangeArgs = function (e) {
      var inputValue;
      var range;
      var startDate = !sf.base.isNullOrUndefined(this.startValue) ? this.globalize.formatDate(this.startValue, {
        format: this.formatString,
        type: 'date',
        skeleton: sf.base.isBlazor() ? 'd' : 'yMd'
      }) : null;
      var endDate = !sf.base.isNullOrUndefined(this.endValue) ? this.globalize.formatDate(this.endValue, {
        format: this.formatString,
        type: 'date',
        skeleton: sf.base.isBlazor() ? 'd' : 'yMd'
      }) : null;
    ...
    DateRangePicker.prototype.selectRange = function (event, element) {
      ...
      var date = sf.base.isNullOrUndefined(event) ? this.getIdValue(null, element) : this.getIdValue(event, null);
    ...
    DateRangePicker.prototype.updateMinMaxDays = function (calendar) {
      if (!sf.base.isNullOrUndefined(this.startValue) && sf.base.isNullOrUndefined(this.endValue) || this.isMobile && this.endButton.element.classList.contains(ACTIVE)) {
        if (!sf.base.isNullOrUndefined(this.minDays) && this.minDays > 0 || !sf.base.isNullOrUndefined(this.maxDays) && this.maxDays > 0) {
    ...
    DateRangePicker.prototype.updateHeader = function () {
      var format = {
        type: 'date',
        skeleton: sf.base.isBlazor() ? 'D' : 'yMMMd'
      };
      ...
      if (this.isDateDisabled(this.startValue) || this.isDateDisabled(this.endValue) || !sf.base.isNullOrUndefined(this.startValue) && +this.startValue < +this.min || !sf.base.isNullOrUndefined(this.endValue) && +this.endValue > +this.max || !sf.base.isNullOrUndefined(this.startValue) && !sf.base.isNullOrUndefined(this.endValue) && +this.startValue > +this.endValue) {
        if (!this.isMobile) {
          this.popupObj.element.querySelector('.' + DAYSPAN).textContent = this.l10n.getConstant('selectedDays');
          this.popupObj.element.querySelector('.' + STARTLABEL).textContent = this.l10n.getConstant('startLabel');
          this.popupObj.element.querySelector('.' + ENDLABEL).textContent = this.l10n.getConstant('endLabel');
    ...
    DateRangePicker.prototype.createRangeHeader = function () {
      ...
      if (!this.isMobile) {
        ...
        sf.base.attributes(startLabel, {
          'aria-atomic': 'true',
          'aria-live': 'assertive',
          'aria-label': 'Start Date',
          'role': 'button'
        });
        sf.base.attributes(endLabel, {
          'aria-atomic': 'true',
          'aria-live': 'assertive',
          'aria-label': 'End Date',
          'role': 'button'
        ...
        this.startButton = new sf.buttons.Button({
          content: this.l10n.getConstant('startLabel')
        }, startBtn);
        this.endButton = new sf.buttons.Button({
    ...
    DateRangePicker.prototype.selectNextMonth = function () {
      if (!sf.base.isNullOrUndefined(this.endValue) && !sf.base.isNullOrUndefined(this.startValue) && !this.isSameMonth(this.endValue, this.currentDate) && !this.isDateDisabled(this.endValue) && !this.isDateDisabled(this.startValue)) {
        this.currentDate = new Date(+this.endValue);
      } else {
        this.currentDate.setDate(1);
        this.currentDate.setMonth(this.currentDate.getMonth() + 1);
      ...
      if (!sf.base.isNullOrUndefined(this.startValue) && +this.startValue < +this.min || !sf.base.isNullOrUndefined(this.endValue) && +this.endValue > +this.max || !sf.base.isNullOrUndefined(this.startValue) && !sf.base.isNullOrUndefined(this.endValue) && +this.startValue > +this.endValue) {
    ...
    DateRangePicker.prototype.selectNextYear = function () {
      if (!sf.base.isNullOrUndefined(this.endValue) && !sf.base.isNullOrUndefined(this.startValue) && !this.isSameYear(this.endValue, this.currentDate) && !this.isDateDisabled(this.endValue) && !this.isDateDisabled(this.startValue)) {
        this.currentDate = new Date(+this.endValue);
      } else {
      ...
      if (!sf.base.isNullOrUndefined(this.endValue) && +this.endValue > +this.max || !sf.base.isNullOrUndefined(this.startValue) && !sf.base.isNullOrUndefined(this.endValue) && +this.startValue > +this.endValue || !sf.base.isNullOrUndefined(this.startValue) && +this.startValue < +this.min) {
        this.currentDate = new Date(new Date().setHours(0, 0, 0, 0));
        this.currentDate.setMonth(0);
    ...
    DateRangePicker.prototype.selectNextDecade = function () {
      if (!sf.base.isNullOrUndefined(this.endValue) && !sf.base.isNullOrUndefined(this.startValue) && !this.isSameDecade(this.endValue, this.currentDate) && !this.isDateDisabled(this.endValue) && !this.isDateDisabled(this.startValue)) {
        this.currentDate = new Date(+this.endValue);
      } else {
      ...
      if (!sf.base.isNullOrUndefined(this.startValue) && !sf.base.isNullOrUndefined(this.endValue) && +this.startValue > +this.endValue || !sf.base.isNullOrUndefined(this.endValue) && +this.endValue > +this.max || !sf.base.isNullOrUndefined(this.startValue) && +this.startValue < +this.min) {
        this.currentDate = new Date(new Date().setHours(0, 0, 0, 0));
    ...
    DateRangePicker.prototype.selectStartMonth = function () {
      ...
      if (!sf.base.isNullOrUndefined(this.endValue) && +this.endValue > +this.max || !sf.base.isNullOrUndefined(this.startValue) && +this.startValue < +this.min || !sf.base.isNullOrUndefined(this.startValue) && !sf.base.isNullOrUndefined(this.endValue) && +this.startValue > +this.endValue) {
        this.currentDate = new Date(new Date().setHours(0, 0, 0, 0));
      }
      ...
      if (!sf.base.isNullOrUndefined(this.popupObj)) {
        ...
        if (this.isMobile) {
          ...
          if (!this.isMobile && view === this.depth) {
            ...
            if (element === this.leftCalendar && (e && !e.currentTarget.children[0].classList.contains('e-icons') || !sf.base.isNullOrUndefined(this.controlDown))) {
              this.leftCalCurrentDate = new Date(+this.currentDate);
              this.effect = '';
              this.currentDate = this.leftCalCurrentDate;
              this.updateCalendarElement(this.leftCalendar);
            ...
            } else if (e && !e.currentTarget.children[0].classList.contains('e-icons') || !sf.base.isNullOrUndefined(this.controlDown)) {
              this.rightCalCurrentDate = new Date(+this.currentDate);
              this.effect = '';
              this.currentDate = this.rightCalCurrentDate;
              this.updateCalendarElement(this.rightCalendar);
    ...
    DateRangePicker.prototype.createControl = function () {
      ...
      this.cancelButton = new sf.buttons.Button({
        content: this.l10n.getConstant('cancelText')
      }, cancelBtn);
      this.applyButton = new sf.buttons.Button({
    ...
    DateRangePicker.prototype.renderPopup = function () {
      ...
      this.popupObj = new sf.popups.Popup(this.popupWrapper, {
        relateTo: this.isMobile && this.isCustomWindow ? document.body : !sf.base.isNullOrUndefined(this.targetElement) ? this.targetElement : this.inputWrapper.container,
        position: this.isMobile ? !sf.base.isUndefined(this.presets[0].start && this.presets[0].end && this.presets[0].label) && !this.isCustomWindow ? // eslint-disable-next-line @typescript-eslint/naming-convention
        {
          X: 'left',
          Y: 'bottom'
        } : {
        ...
        offsetY: OFFSETVALUE,
        collision: this.isMobile ? !sf.base.isUndefined(this.presets[0].start && this.presets[0].end && this.presets[0].label) && !this.isCustomWindow ? // eslint-disable-next-line @typescript-eslint/naming-convention
        {
          X: 'fit'
        } : {
          X: 'fit',
    ...
    DateRangePicker.prototype.documentHandler = function (e) {
      ...
      if (!this.inputWrapper.container.contains(target) || !sf.base.isNullOrUndefined(this.popupObj) && !sf.base.closest(target, '[id="' + this.popupWrapper.id + '"]')) {
        if (e.type !== 'touchstart' && (e.type === 'mousedown' || this.closeEventArgs && !this.closeEventArgs.cancel)) {
          e.preventDefault();
        }
      }

      if ((sf.base.isNullOrUndefined(this.targetElement) || !sf.base.isNullOrUndefined(this.targetElement) && !(target === this.targetElement)) && !sf.base.closest(target, '[id="' + this.popupWrapper.id + '"]') && !(sf.base.closest(target, '.' + INPUTCONTAINER) === this.inputWrapper.container) && !(sf.base.closest(target, '.e-daterangepicker.e-popup') && !target.classList.contains('e-day'))) {
        this.preventBlur = false;
    ...
    DateRangePicker.prototype.checkInvalidRange = function (value) {
      if (!sf.base.isNullOrUndefined(value)) {
        ...
        if (typeof value === 'string') {
          ...
          if (!(startinvalue instanceof Date) && _typeof(startinvalue) !== 'object') {
          ...
          if (!(endinvalue instanceof Date) && _typeof(endinvalue) !== 'object') {
        ...
        if (sf.base.isNullOrUndefined(startString) && !startObject && !sf.base.isNullOrUndefined(endString) || !sf.base.isNullOrUndefined(startString) && !endObject && sf.base.isNullOrUndefined(endString)) {
          invalid = true;
        }
    ...
    DateRangePicker.prototype.virtualRenderCellEvent = function (args) {
      sf.base.extend(this.virtualRenderCellArgs, {
        name: 'renderDayCell'
      });
        ...
        if (!this.isPopupOpen()) {
          ...
          this.trigger('open', eventArgs, function (eventArgs) {
            ...
            if (!_this.openEventArgs.cancel) {
              ...
              _this.isMobile || sf.base.Browser.isDevice);
            }
          });
        }
      }
        ...
        switch (prop) {
          ...
          case 'value':
            ...
            if (typeof newProp.value === 'string') {
              ...
              if (!sf.base.isNullOrUndefined(newProp.value) && newProp.value.length > 0 || !sf.base.isNullOrUndefined(newProp.value) && newProp.value.start) {
                ...
                if (sf.base.isNullOrUndefined(this.value) || newProp.value.start == null) {
                  this.valueType = newProp.value;
                  this.startValue = null;
                  this.endValue = null;
                  this.clearModelvalue(newProp, oldProp);
    ...
    __decorate([sf.base.Property(null)], DateRangePicker.prototype, "value", void 0);

    __decorate([sf.base.Property(false)], DateRangePicker.prototype, "enablePersistence", void 0);

    __decorate([sf.base.Property(new Date(1900, 0, 1))], DateRangePicker.prototype, "min", void 0);

    __decorate([sf.base.Property(new Date(2099, 11, 31))], DateRangePicker.prototype, "max", void 0);

    __decorate([sf.base.Property(null)], DateRangePicker.prototype, "locale", void 0);

    __decorate([sf.base.Property(null)], DateRangePicker.prototype, "firstDayOfWeek", void 0);

    __decorate([sf.base.Property(false)], DateRangePicker.prototype, "weekNumber", void 0);

    __decorate([sf.base.Property('Gregorian')], DateRangePicker.prototype, "calendarMode", void 0);

    __decorate([sf.base.Property(false)], DateRangePicker.prototype, "openOnFocus", void 0);

    __decorate([sf.base.Event()], DateRangePicker.prototype, "created", void 0);

    __decorate([sf.base.Event()], DateRangePicker.prototype, "destroyed", void 0);

    __decorate([sf.base.Event()], DateRangePicker.prototype, "change", void 0);

    __decorate([sf.base.Event()], DateRangePicker.prototype, "cleared", void 0);

    __decorate([sf.base.Event()], DateRangePicker.prototype, "navigated", void 0);

    __decorate([sf.base.Event()], DateRangePicker.prototype, "renderDayCell", void 0);

    __decorate([sf.base.Property(null)], DateRangePicker.prototype, "startDate", void 0);

    __decorate([sf.base.Property(null)], DateRangePicker.prototype, "endDate", void 0);

    __decorate([sf.base.Collection([{}], Presets)], DateRangePicker.prototype, "presets", void 0);

    __decorate([sf.base.Property('')], DateRangePicker.prototype, "width", void 0);

    __decorate([sf.base.Property(1000)], DateRangePicker.prototype, "zIndex", void 0);

    __decorate([sf.base.Property(true)], DateRangePicker.prototype, "showClearButton", void 0);

    __decorate([sf.base.Property(true)], DateRangePicker.prototype, "showTodayButton", void 0);

    __decorate([sf.base.Property('Month')], DateRangePicker.prototype, "start", void 0);

    __decorate([sf.base.Property('Month')], DateRangePicker.prototype, "depth", void 0);

    __decorate([sf.base.Property('')], DateRangePicker.prototype, "cssClass", void 0);

    __decorate([sf.base.Property('-')], DateRangePicker.prototype, "separator", void 0);

    __decorate([sf.base.Property(null)], DateRangePicker.prototype, "minDays", void 0);

    __decorate([sf.base.Property(null)], DateRangePicker.prototype, "maxDays", void 0);

    __decorate([sf.base.Property(false)], DateRangePicker.prototype, "strictMode", void 0);

    __decorate([sf.base.Property(null)], DateRangePicker.prototype, "keyConfigs", void 0);

    __decorate([sf.base.Property(null)], DateRangePicker.prototype, "format", void 0);

    __decorate([sf.base.Property(true)], DateRangePicker.prototype, "enabled", void 0);

    __decorate([sf.base.Property(false)], DateRangePicker.prototype, "readonly", void 0);

    __decorate([sf.base.Property(true)], DateRangePicker.prototype, "allowEdit", void 0);

    __decorate([sf.base.Property('Never')], DateRangePicker.prototype, "floatLabelType", void 0);

    __decorate([sf.base.Property(null)], DateRangePicker.prototype, "placeholder", void 0);

    __decorate([sf.base.Property({})], DateRangePicker.prototype, "htmlAttributes", void 0);

    __decorate([sf.base.Event()], DateRangePicker.prototype, "open", void 0);

    __decorate([sf.base.Event()], DateRangePicker.prototype, "close", void 0);

    __decorate([sf.base.Event()], DateRangePicker.prototype, "select", void 0);

    __decorate([sf.base.Event()], DateRangePicker.prototype, "focus", void 0);

    __decorate([sf.base.Event()], DateRangePicker.prototype, "blur", void 0);

    DateRangePicker = __decorate([sf.base.NotifyPropertyChanges], DateRangePicker);
    return DateRangePicker;
