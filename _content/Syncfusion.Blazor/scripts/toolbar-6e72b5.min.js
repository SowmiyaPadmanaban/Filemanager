...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bundles/toolbar.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _modules_toolbar_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/toolbar.js */ "./modules/toolbar.js");
/* harmony import */ var _modules_toolbar_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_toolbar_js__WEBPACK_IMPORTED_MODULE_0__);
...
var sftoolbar = function sftoolbar(exports) {
  'use strict';
  ...
  var Item = function (_super) {
    ...
    __decorate([sf.base.Property('auto')], Item.prototype, "width", void 0);

    __decorate([sf.base.Property('')], Item.prototype, "cssClass", void 0);

    __decorate([sf.base.Property(false)], Item.prototype, "showAlwaysInPopup", void 0);

    __decorate([sf.base.Property(false)], Item.prototype, "disabled", void 0);

    __decorate([sf.base.Property('')], Item.prototype, "prefixIcon", void 0);

    __decorate([sf.base.Property('')], Item.prototype, "suffixIcon", void 0);

    __decorate([sf.base.Property(true)], Item.prototype, "visible", void 0);

    __decorate([sf.base.Property('None')], Item.prototype, "overflow", void 0);

    __decorate([sf.base.Property('')], Item.prototype, "template", void 0);

    __decorate([sf.base.Property('Button')], Item.prototype, "type", void 0);

    __decorate([sf.base.Property('Both')], Item.prototype, "showTextOn", void 0);

    __decorate([sf.base.Property(null)], Item.prototype, "htmlAttributes", void 0);

    __decorate([sf.base.Property('')], Item.prototype, "tooltipText", void 0);

    __decorate([sf.base.Property('Left')], Item.prototype, "align", void 0);

    __decorate([sf.base.Event()], Item.prototype, "click", void 0);
  ...
  var Toolbar = function (_super) {
    ...
    Toolbar.prototype.clickHandler = function (e) {
      ...
      if (!eventArgs.cancel) {
        this.trigger('clicked', eventArgs, function (clickedArgs) {
          if (!sf.base.isNullOrUndefined(_this.popObj) && isPopupElement && !clickedArgs.cancel && _this.overflowMode === 'Popup' && clickedArgs.item && clickedArgs.item.type !== 'Input') {
            _this.popObj.hide({
              name: 'FadeOut',
              duration: 100
            });
    ...
    Toolbar.prototype.templateRender = function (templateProp, innerEle, item, index) {
      ...
      if (_typeof(templateProp) === 'object') {
      ...
      if (typeof templateProp === 'string' || !isComponent) {
        ...
        try {
          if (_typeof(templateProp) === 'object' && !sf.base.isNullOrUndefined(templateProp.tagName)) {
    ...
    Toolbar.prototype.buttonRendering = function (item, innerEle) {
      ...
      var btnObj = new sf.buttons.Button({
        iconCss: iconCss,
      ...
      if (item.width) {
        sf.base.setStyleAttribute(dom, {
          'width': sf.base.formatUnit(item.width)
        });
      }
    ...
    Toolbar.prototype.onPropertyChanged = function (newProp, oldProp) {
      ...
      for (var _i = 0, _a = Object.keys(newProp); _i < _a.length; _i++) {
        ...
        switch (prop) {
          ...
          case 'width':
            sf.base.setStyleAttribute(tEle, {
    ...
    Toolbar.prototype.hideItem = function (index, value) {
      var isElement = _typeof(index) === 'object' ? true : false;
      var eleIndex = index;
      var initIndex;
      var ele;
      var innerItems = [].slice.call(sf.base.selectAll('.' + CLS_ITEM, this.element));
    ...
    __decorate([sf.base.Collection([], Item)], Toolbar.prototype, "items", void 0);

    __decorate([sf.base.Property('auto')], Toolbar.prototype, "width", void 0);

    __decorate([sf.base.Property('auto')], Toolbar.prototype, "height", void 0);

    __decorate([sf.base.Property('')], Toolbar.prototype, "cssClass", void 0);

    __decorate([sf.base.Property('Scrollable')], Toolbar.prototype, "overflowMode", void 0);

    __decorate([sf.base.Property()], Toolbar.prototype, "scrollStep", void 0);

    __decorate([sf.base.Property(true)], Toolbar.prototype, "enableCollision", void 0);

    __decorate([sf.base.Property(true)], Toolbar.prototype, "enableHtmlSanitizer", void 0);

    __decorate([sf.base.Property(true)], Toolbar.prototype, "allowKeyboard", void 0);

    __decorate([sf.base.Event()], Toolbar.prototype, "clicked", void 0);

    __decorate([sf.base.Event()], Toolbar.prototype, "created", void 0);

    __decorate([sf.base.Event()], Toolbar.prototype, "destroyed", void 0);

    __decorate([sf.base.Event()], Toolbar.prototype, "beforeCreate", void 0);

    Toolbar = __decorate([sf.base.NotifyPropertyChanges], Toolbar);
    return Toolbar;
  }(sf.base.Component);
  /**
   * Toolbar modules
