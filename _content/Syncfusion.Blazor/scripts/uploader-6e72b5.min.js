...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bundles/uploader.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _modules_uploader_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/uploader.js */ "./modules/uploader.js");
/* harmony import */ var _modules_uploader_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_uploader_js__WEBPACK_IMPORTED_MODULE_0__);
...
var sfuploader = function sfuploader(exports) {
  'use strict';
  ...
  var FilesProp = function (_super) {
    ...
    __decorate([sf.base.Property('')], FilesProp.prototype, "name", void 0);

    __decorate([sf.base.Property(null)], FilesProp.prototype, "size", void 0);

    __decorate([sf.base.Property('')], FilesProp.prototype, "type", void 0);

    return FilesProp;
  }(sf.base.ChildProperty);

  var ButtonsProps = function (_super) {
    ...
    __decorate([sf.base.Property('Browse...')], ButtonsProps.prototype, "browse", void 0);

    __decorate([sf.base.Property('Upload')], ButtonsProps.prototype, "upload", void 0);

    __decorate([sf.base.Property('Clear')], ButtonsProps.prototype, "clear", void 0);

    return ButtonsProps;
  }(sf.base.ChildProperty);

  var AsyncSettings = function (_super) {
    ...
    __decorate([sf.base.Property('')], AsyncSettings.prototype, "saveUrl", void 0);

    __decorate([sf.base.Property('')], AsyncSettings.prototype, "removeUrl", void 0);

    __decorate([sf.base.Property(0)], AsyncSettings.prototype, "chunkSize", void 0);

    __decorate([sf.base.Property(3)], AsyncSettings.prototype, "retryCount", void 0);

    __decorate([sf.base.Property(500)], AsyncSettings.prototype, "retryAfterDelay", void 0);
  ...
  var Uploader = function (_super) {
    ...
    Uploader.prototype.preRender = function () {
      ...
      this.isBlazorSaveUrl = this.isServerRendered && (this.asyncSettings.saveUrl === '' || sf.base.isNullOrUndefined(this.asyncSettings.saveUrl)) ? true : false;
    ...
    Uploader.prototype.renderButtonTemplates = function () {
      ...
      if (this.uploadButton) {
        var uploadText = sf.base.isNullOrUndefined(this.buttons.upload) ? 'Upload' : this.buttons.upload;
      ...
      if (this.clearButton) {
        var clearText = sf.base.isNullOrUndefined(this.buttons.clear) ? 'Clear' : this.buttons.clear;
    ...
    Uploader.prototype.setDropArea = function () {
      ...
      if (this.dropArea) {
        this.dropZoneElement = typeof this.dropArea !== 'string' ? this.dropArea : sf.base.select(this.dropArea, document);
        ...
        for (var _i = 0, _a = Object.keys(this.htmlAttributes); _i < _a.length; _i++) {
          ...
          if (wrapperAttr.indexOf(pro) > -1) {
            if (pro === 'class') {
              ...
              uploadStyle = !sf.base.isNullOrUndefined(uploadStyle) ? uploadStyle + this.htmlAttributes[pro] : this.htmlAttributes[pro];
    ...
    Uploader.prototype.setRTL = function () {
      if (this.enableRtl) {
        sf.base.addClass([this.uploadWrapper], RTL);
      } else {
        sf.base.removeClass([this.uploadWrapper], RTL);
      }
    };
    ...
    Uploader.prototype.checkHTMLAttributes = function (isDynamic) {
      var attributes = isDynamic ? sf.base.isNullOrUndefined(this.htmlAttributes) ? [] : Object.keys(this.htmlAttributes) : ['accept', 'multiple', 'disabled'];
        ...
        if (!sf.base.isNullOrUndefined(this.element.getAttribute(prop))) {
          switch (prop) {
            case 'accept':
              ...
              if (sf.base.isNullOrUndefined(this.uploaderOptions) || this.uploaderOptions['allowedExtensions'] === undefined || isDynamic) {
                this.setProperties({
    ...
    Uploader.prototype.remove = function (fileData, customTemplate, removeDirectly, postRawFile, args) {
      ...
      this.trigger('beforeRemove', beforeEventArgs, function (beforeEventArgs) {
        if (!beforeEventArgs.cancel) {
          ...
          if (_this.isFormUpload() && !_this.isBlazorSaveUrl) {
          ...
          } else if (_this.isForm && (sf.base.isNullOrUndefined(_this.asyncSettings.removeUrl) || _this.asyncSettings.removeUrl === '') && !_this.isBlazorSaveUrl) {
            ...
            var _loop_6 = function _loop_6(files) {
    ...
    __decorate([sf.base.Property(false)], Uploader.prototype, "sequentialUpload", void 0);

    __decorate([sf.base.Property({})], Uploader.prototype, "htmlAttributes", void 0);

    __decorate([sf.base.Property('')], Uploader.prototype, "cssClass", void 0);

    __decorate([sf.base.Property(true)], Uploader.prototype, "enabled", void 0);

    __decorate([sf.base.Property(null)], Uploader.prototype, "template", void 0);

    __decorate([sf.base.Property(true)], Uploader.prototype, "multiple", void 0);

    __decorate([sf.base.Property(true)], Uploader.prototype, "autoUpload", void 0);

    __decorate([sf.base.Complex({}, ButtonsProps)], Uploader.prototype, "buttons", void 0);

    __decorate([sf.base.Property('')], Uploader.prototype, "allowedExtensions", void 0);

    __decorate([sf.base.Property(0)], Uploader.prototype, "minFileSize", void 0);

    __decorate([sf.base.Property(30000000)], Uploader.prototype, "maxFileSize", void 0);

    __decorate([sf.base.Property(null)], Uploader.prototype, "dropArea", void 0);

    __decorate([sf.base.Collection([{}], FilesProp)], Uploader.prototype, "files", void 0);

    __decorate([sf.base.Property(true)], Uploader.prototype, "showFileList", void 0);

    __decorate([sf.base.Property(false)], Uploader.prototype, "directoryUpload", void 0);

    __decorate([sf.base.Property('Default')], Uploader.prototype, "dropEffect", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "created", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "actionComplete", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "rendering", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "beforeUpload", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "fileListRendering", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "selected", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "uploading", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "success", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "failure", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "removing", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "beforeRemove", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "clearing", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "progress", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "change", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "chunkSuccess", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "chunkFailure", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "chunkUploading", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "canceling", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "pausing", void 0);

    __decorate([sf.base.Event()], Uploader.prototype, "resuming", void 0);

    Uploader = __decorate([sf.base.NotifyPropertyChanges], Uploader);
    return Uploader;
  }(sf.base.Component);
